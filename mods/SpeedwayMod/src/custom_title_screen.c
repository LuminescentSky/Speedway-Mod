...
void CustomTitleScreen()
{
    ...
    if (mod_state == GAME_STARTED && _globalTimer > 20) {
        ...
        DrawTextAll(
            stringList[3],
            &(CapitalTextInfo){.x = 0x8, .y = SCREEN_BOTTOM_EDGE - 0x88, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[0]
        );
        ...
        DrawTextAll(
            &asciiValue[0],
            &(CapitalTextInfo){.x = SCREEN_RIGHT_EDGE - 0x2c, .y = SCREEN_BOTTOM_EDGE - 0x88, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[0]
        );
        DrawTextAll(
            stringList[4],
            &(CapitalTextInfo){.x = 0x8, .y = SCREEN_BOTTOM_EDGE - 0x70, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[1]
        );
        DrawTextAll(
            ...
            &(CapitalTextInfo){.x = SCREEN_RIGHT_EDGE - 0x2c, .y = SCREEN_BOTTOM_EDGE - 0x70, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[1]
        );
        DrawTextAll(
            stringList[5],
            &(CapitalTextInfo){.x = 0x8, .y = SCREEN_BOTTOM_EDGE - 0x58, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
        ...
        DrawTextAll(
            ...
            &(CapitalTextInfo){.x = SCREEN_RIGHT_EDGE - 0x2c, .y = SCREEN_BOTTOM_EDGE - 0x58, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[2]
        );
        DrawTextAll(
            stringList[6],
            &(CapitalTextInfo){.x = 0x8, .y = SCREEN_BOTTOM_EDGE - 0x40, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
        ...
        DrawTextAll(
            ...
            &(CapitalTextInfo){.x = SCREEN_RIGHT_EDGE - 0x2c, .y = SCREEN_BOTTOM_EDGE - 0x40, .size = DEFAULT_SIZE},
            &(LowercaseTextInfo){.spacing = DEFAULT_SPACING, .yOffset = 0, .size = DEFAULT_SIZE},
            DEFAULT_SPACING,
            customMenuColorArray[3]
        );
